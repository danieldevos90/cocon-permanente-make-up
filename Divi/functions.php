...
function et_setup_theme() {
	...
	if ( file_exists( $template_directory . '/inc/woocommerce-custom.php' ) ) {
		require_once $template_directory . '/inc/woocommerce-custom.php';
	}
...
function et_divi_load_scripts_styles(){
	...
	// WooCommerce Product Gallery - Optimized external JS (was inline, causing Chrome lag)
	if ( is_product() ) {
		wp_enqueue_script( 'divi-product-gallery', $template_dir . '/js/product-gallery.js', array( 'jquery' ), $theme_version, true );
	}
	
	// DEBUG: Scroll performance logging
	wp_enqueue_script( 'divi-scroll-debug', $template_dir . '/js/scroll-debug.js', array(), $theme_version, true );
...
function et_divi_sidebar_class( $classes ) {
	...
	// Always use full width layout - no sidebars
	$classes[] = 'et_full_width_page';

	// Maybe add the full width portfolio class for project post types.
...
function et_divi_output_content_wrapper_end() {
	// No sidebar - full width layout for all pages
	echo '
			</div>
		</div>
	</div>';
