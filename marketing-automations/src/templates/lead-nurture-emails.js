    ...
    getContent(data = {}) {
      const content = `
        ...
        <p style="text-align: center; margin: 30px 0;">
          ...
          <br><br>
          <a href="${config.urls.portfolio}" class="button button-secondary" style="display: inline-block; padding: 12px 28px; text-decoration: none; border-radius: 25px; font-weight: 500; margin: 5px;">
    ...
    getContent(data = {}) {
      const content = `
        ...
        <div style="background-color: #faf8f5; padding: 25px; border-radius: 8px; margin-bottom: 20px;">
          ...
          <p style="color: #a30077; margin: 0; font-weight: 600;">– Jennifer (5/5)</p>
        </div>
        ...
        <div style="background-color: #faf8f5; padding: 25px; border-radius: 8px; margin-bottom: 20px;">
          ...
          <p style="color: #a30077; margin: 0; font-weight: 600;">– Rachel (5/5)</p>
        </div>
        ...
        <div style="background-color: #faf8f5; padding: 25px; border-radius: 8px; margin-bottom: 20px;">
          ...
          <p style="color: #a30077; margin: 0; font-weight: 600;">– Ilse (5/5)</p>
        </div>
        ...
        <div style="background-color: #faf8f5; padding: 25px; border-radius: 8px; margin-bottom: 20px;">
          ...
          <p style="color: #a30077; margin: 0; font-weight: 600;">– Femke (5/5)</p>
        </div>
