...
require_once CPM_OPL_PATH . 'includes/class-pricing.php';
require_once CPM_OPL_PATH . 'includes/class-cohort-schedule.php';
require_once CPM_OPL_PATH . 'includes/class-mailchimp.php';
require_once CPM_OPL_PATH . 'includes/class-enrollment-status.php';
require_once CPM_OPL_PATH . 'includes/class-woocommerce-hide.php';
require_once CPM_OPL_PATH . 'includes/class-landing-price-fix.php';
...
add_action( 'plugins_loaded', static function () {
	if ( ! get_option( 'cpm_opl_thankyou_page_id' ) ) {
		$page = get_page_by_path( 'opleiding-bedankt' );
		if ( $page ) {
			update_option( 'cpm_opl_thankyou_page_id', (int) $page->ID, false );
		}
	}
	...
	CPM_Opleidingen\Cohort_Schedule::register();
	CPM_Opleidingen\Enrollment_Status::register();
	CPM_Opleidingen\WooCommerce_Hide::register();
	CPM_Opleidingen\Landing_Price_Fix::register();
